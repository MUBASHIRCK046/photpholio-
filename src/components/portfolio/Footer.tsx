  ...
  return (
    <footer className="relative z-10 mt-auto border-t border-pearl/10">
      <div className="mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-2 border-t border-pearl/10 pt-6 text-center md:flex-row">
          <p className="flex items-center gap-1.5 text-xs text-pearl/40">
            © {year} {profile.name}. Crafted with
            <Heart className="h-3 w-3 text-rose-300" /> &amp; WebGL.
          </p>
          <p className="text-xs text-pearl/40">
            Liquid Glass · Built with Next.js, Framer Motion &amp; GLSL shaders.
          </p>
        </div>
      </div>
    </footer>
